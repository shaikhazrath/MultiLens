...
const systemRoles = [
  {
    ...
    "charecter": "motivational speaker"
  },
  {
    "role": "system",
...
export const reply = async (id, post) => {
  try {
    for (const systemRole of systemRoles) {
      ...
      console.log(systemRole.charecter);
      const data = {
        post: id,
        comment,
        charecter: systemRole.charecter
      };
